...
class PirateSpider(CrawlSpider):
	...
	rules = (Rule(SgmlLinkExtractor(allow=('/torrent/',),),callback='parse_tpb_torrent' , follow=True),
	...
	def parse_tpb_torrent(self, response):
		...
		if page['seeds']: pass 
		else : page['seeds'] = hxs.select('//*[@id="details"]/dl[2]/dd[3]/text()').extract()

		if page['seeds'] != "": page['seeds'] = hxs.select('//*[@id="details"]/dl[1]/dd[8]//text()').extract()            
		...
		page['magnet']   = hxs.select('//*[@id="details"]/div[3]/a[1]/@href').extract()
		if page['magnet']: pass
		else: page['magnet'] = hxs.select('//*[@id="details"]/div[4]/a/@href').extract()
		# try it firefox's way too
		if page['magnet']: pass	
		else: page['magnet'] = hxs.select('/html/body/div[3]/div[2]/div/div/div/div[2]/div[10]/a/@href').extract()
		

										
		#//*[@id="details"]/div[3]/a
		#/html/body/table/tbody/tr[211]/td[2]/span[1]/a
		page['torrent']  = hxs.select('//*[@id="details"]/div[4]/a[2]/@href').extract()	
		if page['torrent'] : pass
		else: page['torrent'] = hxs.select('//*[@id="details"]/div[3]/a[2]/@href').extract()
		 
		page['category'] = hxs.select('//*[@id="details"]/dl[1]/dd[1]/a/text()').extract()	
		#page['seeds']	 = hxs.select('//*[@id="details"]/dl[1]/dd[7]/text()').extract()
		...
		page['added']    = hxs.select('//*[@id="details"]/dl[1]/dd[5]/text()').extract()
		if page['added']: pass
		else: page['added'] = hxs.select('//*[@id="details"]/dl[2]/dd[1]/text()').extract()
						   

		page['uploader'] = hxs.select('//*[@id="details"]/dl[1]/dd[6]/a/text()').extract()
		if page['uploader'] : pass
		else: page['uploader'] = hxs.select('//*[@id="details"]/dl[2]/dd[2]/a/text()').extract()	
